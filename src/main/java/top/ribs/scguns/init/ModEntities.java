...
{
    public static final DeferredRegister<EntityType<?>> ENTITIES = DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, NeoScorchedGunsMain.MODID);
    public static final RegistryObject<EntityType<PrimedPowderKeg>> PRIMED_POWDER_KEG = ENTITIES.register("primed_powder_keg",
            () -> EntityType.Builder.<PrimedPowderKeg>of(PrimedPowderKeg::new, MobCategory.MISC)
                    .sized(0.98F, 0.98F)
                    .clientTrackingRange(10)
                    .updateInterval(10)
                    .build("primed_powder_keg"));
    public static final RegistryObject<EntityType<PrimedNitroKeg>> PRIMED_NITRO_KEG = ENTITIES.register("primed_nitro_keg",
            () -> EntityType.Builder.<PrimedNitroKeg>of(PrimedNitroKeg::new, MobCategory.MISC)
                    .sized(0.98F, 0.98F)
                    .clientTrackingRange(10)
                    .updateInterval(10)
                    .build("primed_nitro_keg"));
    public static final RegistryObject<EntityType<TurretProjectileEntity>> TURRET_PROJECTILE = ENTITIES.register("basic_turret", () ->
    ...
    /* Mobs */
    public static final RegistryObject<EntityType<CogMinionEntity>> COG_MINION = ENTITIES.register("cog_minion", () -> EntityType.Builder.of(CogMinionEntity::new, MobCategory.MONSTER).sized(0.8F, 2.0F).build("cog_minion"));
    public static final RegistryObject<EntityType<CogKnightEntity>> COG_KNIGHT = ENTITIES.register("cog_knight", () -> EntityType.Builder.of(CogKnightEntity::new, MobCategory.MONSTER).sized(0.8F, 2.2F).build("cog_knight"));
    public static final RegistryObject<EntityType<SkyCarrierEntity>> SKY_CARRIER = ENTITIES.register("sky_carrier", () -> EntityType.Builder.of(SkyCarrierEntity::new, MobCategory.MONSTER).sized(1.4F, 1.7F).build("sky_carrier"));
    public static final RegistryObject<EntityType<HiveEntity>> HIVE = ENTITIES.register("hive", () -> EntityType.Builder.of(HiveEntity::new, MobCategory.MONSTER).sized(0.8F, 2.0F).build("hive"));
    public static final RegistryObject<EntityType<SwarmEntity>> SWARM = ENTITIES.register("swarm", () -> EntityType.Builder.of(SwarmEntity::new, MobCategory.MONSTER).sized(0.8F, 2.0F).build("swarm"));
    public static final RegistryObject<EntityType<RedcoatEntity>> REDCOAT = ENTITIES.register("redcoat", () -> EntityType.Builder.of(RedcoatEntity::new, MobCategory.MONSTER).sized(0.6F, 1.95F).build("redcoat"));
    public static final RegistryObject<EntityType<SupplyScampEntity>> SUPPLY_SCAMP = ENTITIES.register("supply_scamp", () -> EntityType.Builder.of(SupplyScampEntity::new, MobCategory.CREATURE).sized(1.0F, 1.3F).build("supply_scamp"));
    public static final RegistryObject<EntityType<DissidentEntity>> DISSIDENT = ENTITIES.register("dissident", () -> EntityType.Builder.of(DissidentEntity::new, MobCategory.MONSTER).sized(1.4F, 1.7F).build("dissident"));
    public static final RegistryObject<EntityType<HornlinEntity>> HORNLIN = ENTITIES.register("hornlin", () -> EntityType.Builder.of(HornlinEntity::new, MobCategory.MONSTER).sized(1.4F, 1.7F).build("hornlin"));
    public static final RegistryObject<EntityType<ZombifiedHornlinEntity>> ZOMBIFIED_HORNLIN = ENTITIES.register("zombified_hornlin", () -> EntityType.Builder.of(ZombifiedHornlinEntity::new, MobCategory.MONSTER).sized(1.4F, 1.7F).build("zombified_hornlin"));
    public static final RegistryObject<EntityType<TheMerchantEntity>> THE_MERCHANT = ENTITIES.register("the_merchant", () ->
            EntityType.Builder.of((EntityType<TheMerchantEntity> entityType, Level level) -> new TheMerchantEntity(entityType, level), MobCategory.MONSTER)
                    .sized(1.5F, 2.25F)
                    .build("the_merchant"));
    public static final RegistryObject<EntityType<BlundererEntity>> BLUNDERER = ENTITIES.register("blunderer", () -> EntityType.Builder.of(BlundererEntity::new, MobCategory.MONSTER).sized(0.8F, 1.7F).build("blunderer"));
    public static final RegistryObject<EntityType<TraumaUnitEntity>> TRAUMA_UNIT = ENTITIES.register("trauma_unit", () -> EntityType.Builder.of(TraumaUnitEntity::new, MobCategory.MONSTER).sized(0.6F, 1.95F).build("trauma_unit"));
    public static final RegistryObject<EntityType<ScampTankEntity>> SCAMP_TANK = ENTITIES.register("scamp_tank", () -> EntityType.Builder.of(ScampTankEntity::new, MobCategory.MONSTER).sized(5.0F, 4F).build("scamp_tank"));
    public static final RegistryObject<EntityType<SignalBeaconEntity>> SIGNAL_BEACON = ENTITIES.register("signal_beacon", () -> EntityType.Builder.of(SignalBeaconEntity::new, MobCategory.MISC).sized(1.0F, 1.0F).build("signal_beacon"));
    public static final RegistryObject<EntityType<ScamplerEntity>> SCAMPLER = ENTITIES.register("scampler", () -> EntityType.Builder.of(ScamplerEntity::new, MobCategory.MONSTER).sized(1.0F, 1.0F).build("scampler"));
    public static final RegistryObject<EntityType<BeaconProjectileEntity>> BEACON_PROJECTILE = ENTITIES.register("beacon_projectile", () ->
    ...
    public static final RegistryObject<EntityType<TraumaHookEntity>> TRAUMA_HOOK = ENTITIES.register("trauma_hook", () -> EntityType.Builder.<TraumaHookEntity>of(TraumaHookEntity::new, MobCategory.MISC)
            .sized(0.25F, 0.25F)
            .setTrackingRange(64)
            .setUpdateInterval(3)
            .setShouldReceiveVelocityUpdates(true)
    ...
    public static final RegistryObject<EntityType<BrassBoltEntity>> BRASS_BOLT = ENTITIES.register("brass_bolt", () ->
            EntityType.Builder.<BrassBoltEntity>of(BrassBoltEntity::new, MobCategory.MISC)
                    ...
                    .setShouldReceiveVelocityUpdates(true)
                    .build("brass_bolt"));
    public static final RegistryObject<EntityType<ScampRocketEntity>> SCAMP_ROCKET = ENTITIES.register("scamp_rocket", () ->
