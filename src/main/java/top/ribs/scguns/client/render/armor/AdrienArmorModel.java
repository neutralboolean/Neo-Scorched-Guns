...
public class AdrienArmorModel extends GeoModel<AdrienArmorItem> {
    ...
    public ResourceLocation getModelResource(AdrienArmorItem animatable) {
        return new ResourceLocation(NeoScorchedGunsMain.MODID, "geo/adrien_armor.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(AdrienArmorItem animatable) {
        return new ResourceLocation(NeoScorchedGunsMain.MODID, "textures/armor/adrien_armor.png");
    }

    @Override
    public ResourceLocation getAnimationResource(AdrienArmorItem animatable) {
        return new ResourceLocation(NeoScorchedGunsMain.MODID, "animations/adrien_armor.animation.json");
    }
}