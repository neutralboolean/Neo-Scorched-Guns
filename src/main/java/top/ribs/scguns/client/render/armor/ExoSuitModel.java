...
public class ExoSuitModel extends GeoModel<ExoSuitItem> {
    ...
    public ResourceLocation getModelResource(ExoSuitItem animatable) {
        return new ResourceLocation(NeoScorchedGunsMain.MODID, "geo/exo_suit.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(ExoSuitItem animatable) {
        return new ResourceLocation(NeoScorchedGunsMain.MODID, "textures/armor/exo_suit.png");
    }

    @Override
    public ResourceLocation getAnimationResource(ExoSuitItem animatable) {
        return new ResourceLocation(NeoScorchedGunsMain.MODID, "animations/exo_suit.animation.json");
    }
}