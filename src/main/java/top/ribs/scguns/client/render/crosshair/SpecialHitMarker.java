...
public class SpecialHitMarker extends Crosshair {
    private static final ResourceLocation NORMAL_HITMARKER = new ResourceLocation(NeoScorchedGunsMain.MODID, "textures/crosshair/special_hit_marker.png");
    private static final ResourceLocation ALT_HITMARKER = new ResourceLocation(NeoScorchedGunsMain.MODID, "textures/crosshair/special_hit_marker2.png");

    public SpecialHitMarker() {
        super(new ResourceLocation(NeoScorchedGunsMain.MODID, "special_hit_marker"));
    }
    ...
    public void render(Minecraft mc, PoseStack stack, int windowWidth, int windowHeight, float partialTicks) {
        ...
        boolean useAltHitMarker = CrosshairHandler.get().getCurrentCrosshair().getLocation().equals(new ResourceLocation(NeoScorchedGunsMain.MODID, "hit_marker"));
